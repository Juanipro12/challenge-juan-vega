  ...
  if (!values.useSameData) {
    const billingValidationSchema = Yup.object({
      billingFirstName: Yup.string().required(
        "Este campo es requerido cuando el checkbox está desmarcado"
      ),
      ...
      billingDocumentNumber: Yup.string()
        ...
        .test(
          ...
          (value) =>
            validateDocumentNumber(value || "", values.billingDocumentType)
        ),
    ...
    try {
      ...
      if (err instanceof Yup.ValidationError) {
        ...
        // Manejar el caso en el que 'err' no es un Yup.ValidationError
          ...
          <Form>
            ...
            <div className="bg-[#181A1F] px-[16px] py-[24px] w-full my-10">
              ...
              <div className="flex items-center my-4">
                ...
                />
                <label className="text-[#9396A5] text-[14px] font-semibold">
            ...
            {errorCustom && (
              <div className="text-red-500 text-lg p-2">{errorCustom}</div>
            )}
          </Form>
        )}
      </Formik>
